...
The included run-rename.pl perl script was created to helpfully rename a bunch of files that you have proper naming about via a torrent file. This is possible by way of embedded CRC hash information within torrent files. Note that not all torrent files have such embedded hash information, so this may not always be possible or work.
